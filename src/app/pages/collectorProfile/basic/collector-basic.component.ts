...
@Component({
  selector: "app-collector-basic",
  templateUrl: "./collector-basic.component.html",
  styleUrls: ["./collector-basic.component.css"],
})
export class CollectorBasicComponent implements OnInit {
