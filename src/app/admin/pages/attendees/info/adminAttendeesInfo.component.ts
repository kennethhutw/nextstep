...
@Component({
  selector: 'app-admin-attendees-info',
  templateUrl: './adminAttendeesInfo.component.html',
  styleUrls: ['./adminAttendeesInfo.component.scss']
})
export class AdminAttendeesInfoComponent implements OnInit, OnDestroy {
